    ...
    <div className="relative form-background px-8 pt-16 rounded-lg">
                    <img onClick={()=>removeItem(id)} className="absolute top-6 right-8 cursor-pointer" src={close} alt="close" />
                       <div className=" flex items-center gap-8">
                        <div className="flex items-center [&>*]:p-2 font-semibold border text-[1.6rem]  md:text-[2rem] rounded-lg">
                        ...
                        <h3 className="text-[1.4rem] md:text-[1.6rem] font-bold self-start px-4">{title}</h3>
                        </div>
                        <div className="w-full flex justify-end text-[1.6rem] md:text-[2rem] font-semibold">€{price}</div>
